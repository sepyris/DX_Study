...
ObjectTrialScene::ObjectTrialScene()
{
	...
	// 추가로,
	// 원래대로라면 이 셰이더들은 셰이더를 이용해서 출력할 도형을 담당하는
...
void ObjectTrialScene::Render()
{
	...
	// 이를 불러오는 코드 그대로 쓰는 건 너무 길어서 비효율적
	// 그래서 매크로를 선언하여 일르 최대한 짧게 줄인 것
...
void ObjectTrialScene::PostRender()
{
}
